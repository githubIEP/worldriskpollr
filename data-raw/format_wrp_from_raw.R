...
wrp_data <- wrp
usethis::use_data(wrp_data, wrp_year_col, wrp_projweight_col, wrp_weight_col, wrp_regions, wrp_disaggregations, wrp_questions, overwrite = TRUE, internal = T, compress = "xz")
