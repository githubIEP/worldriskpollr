...
This significantly reduces processing time and passes the <5 sec criteria on windows systems. However, I still get the NOTE on Fedora and Ubuntu for the function wrp_get(). To address this I have used the function mclapply instead of base lapply to make use of multicore processing. While I still still get the note on Ubuntu and Fedore on the checks, this 
