...
Using the following functions, it will download and process the World Risk Poll data into your package cahce memory, then extract questions of interest.
...
## Removing World Risk Poll Data from your Computer

If you want to remove all World Risk Poll files from your computer, you may run the following:
```{r, message = FALSE, warning = FALSE}
wrp_remove()
```
